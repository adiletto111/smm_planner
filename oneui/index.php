            ...
            <main id="main-container">
                        ...
                        <section class="content content-full content-boxed">
                            ...
                            <div class="push-150-t push-100 text-center">
                                ...
                                <div class="push-50-t push-20 text-center">
                                    ...
                                    <a class="btn btn-noborder btn-lg btn-primary push-5 visibility-hidden" data-toggle="appear" data-class="animated fadeInRight" href="base_pages_dashboard.html">Live Preview</a>
                                </div>
                            </div>
                            <!-- END Section Content -->
                        </section>
                ...
                <div class="bg-gray-lighter">
                    <section class="content content-boxed">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <a class="block block-link-hover2" href="base_pages_dashboard.html">
                            ...
                            <div class="col-sm-4">
                                <a class="block block-link-hover2" href="bd_dashboard.html">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <a class="block block-link-hover2" href="base_pages_dashboard_v2.html">
                            ...
                            <div class="col-sm-4">
                                <a class="block block-link-hover2" href="base_pages_ecom_dashboard.html">
                            ...
                            <div class="col-sm-4">
                                <a class="block block-link-hover2" href="base_pages_ecom_store_home.html">
                            ...
                            <div class="col-sm-4">
                                <a class="block block-link-hover2 ribbon ribbon-bookmark ribbon-success" href="base_pages_crypto_dashboard.html">
                            ...
                            <div class="col-sm-4">
                                <a class="block block-link-hover2" href="base_pages_profile_v2.html">
                            ...
                            <div class="col-sm-4">
                                <a class="block block-link-hover2" href="base_pages_forum_categories.html">
                            ...
                            <div class="col-sm-4">
                                <a class="block block-link-hover2" href="base_pages_blog_classic.html">
                            ...
                            <div class="col-sm-4">
                                <a class="block block-link-hover2" href="base_pages_elearning_courses.html">
                            ...
                            <div class="col-sm-4">
                                <a class="block block-link-hover2" href="base_pages_travel_agency.html">
                            ...
                            <div class="col-sm-4">
                                <a class="block block-link-hover2" href="base_pages_projects_dashboard.html">
                            ...
                            <div class="col-sm-4">
                                <a class="block block-link-hover2" href="base_pages_auth.html">
                            ...
                            <div class="col-sm-4">
                                <a class="block block-link-hover2" href="base_pages_errors.html">
